  ...
  return (
    <div className='header_wrapper text-white'>
        <ul className='contents bg-dark px-4 py-1'>
            <li className='lists'><img className='logo' src={AmazonLogo} alt="" /></li>
            ...
            <li><span className='arrange unique text-dark py-2 border-start'>All<ArrowDropDownIcon/></span><input className='inputField px-2' type="text" placeholder='Search Amazon' /><span className='search_logo p-2 px-3'><FaSearch/></span></li>
        ...
        <ul className='contents pb-2 mx-4 second fw-bold'>
          <li><MenuIcon/>All</li>
          <li>Today's Deals</li>
